...
class Network(object):
    ...
    def SGD(self, training_data, epochs, mini_batch_size, eta,
        ...
        for j in xrange(epochs):
            ...
            mini_batches = [training_data[k:k + mini_batch_size] for k in xrange(0, n, mini_batch_size)]#divide the full batch into n/size counts mini_batch
            for mini_batch in mini_batches:
                self.update_mini_batch(mini_batch, eta)###the key function
            if test_data:###test the grade and print
    ...
    def backprop(self, x, y):
        ...
        for b, w in zip(self.biases, self.weights):
            #calculate all actives value, and store in activations[]
